...
var (
	analyticsPageviewDBTypes = map[string]string{`Host`: `varchar`, `ID`: `bigint`, `InitialRid`: `varchar`, `IsNew`: `tinyint`, `Method`: `varchar`, `Path`: `varchar`, `Query`: `varchar`, `RemoteAddress`: `varchar`, `Scheme`: `varchar`, `Status`: `int`, `UserAgent`: `text`, `ViewedAt`: `timestamp`}
	_                        = bytes.MinRead
)

...
var (
	postColumns               = []string{"id", "title", "slug", "markdown", "html", "status", "published_at", "created_at", "updated_at", "deleted_at", "owned_by_id", "created_by_id", "updated_by_id", "deleted_by_id"}
	postColumnsWithoutDefault = []string{"title", "slug", "markdown", "html", "published_at", "deleted_at", "owned_by_id", "created_by_id", "updated_by_id", "deleted_by_id"}
